try {
    ...
    $path = "c:\Users\adamj\Documents\GitHub\TESTLAUNCHER3\TechCraftLauncher\src\Assets\icon.png"
    $dest = "c:\Users\adamj\Documents\GitHub\TESTLAUNCHER3\TechCraftLauncher\src\Assets\icon.ico"
