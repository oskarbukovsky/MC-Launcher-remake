...
{
    private const string ProtocolScheme = "TechCraft";
    private const string ProtocolName = "TechCraft Launcher Protocol";

    /// <summary>
    /// Registers the TechCraft:// protocol handler in Windows Registry (current user)
    /// </summary>
    ...
    private static string GetAuthCodeFilePath()
    {
        ...
        var dir = Path.Combine(appData, "TechCraftLauncher");
