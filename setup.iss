...
#define MyAppName "TECH-CRAFT Launcher"
#define MyAppPublisher "TECH-CRAFT.EU"
#define MyAppURL "https://wiki.666777123.xyz/"
#define MyAppExeName "TechCraftLauncher.exe"
...
DefaultDirName={localappdata}\TechCraftLauncher
DisableProgramGroupPage=yes
; Remove the following line to run in administrative install mode (install for all users.)
PrivilegesRequired=lowest
OutputDir=Output
OutputBaseFilename=TechCraftLauncher_Setup
SetupIconFile=TechCraftLauncher\src\Assets\icon.ico
Compression=lzma
